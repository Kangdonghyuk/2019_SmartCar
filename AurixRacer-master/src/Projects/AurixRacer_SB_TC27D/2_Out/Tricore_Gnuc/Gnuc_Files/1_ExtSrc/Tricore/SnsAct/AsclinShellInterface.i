...
# 1 "<command-line>"
# 1 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
# 11 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
# 1 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.h" 1
# 14 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.h"
...
# 15 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.h" 2
...
# 16 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.h" 2
...
# 12 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c" 2
# 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/Service/CpuGeneric/SysSe/Time/Ifx_DateTime.h" 1
# 31 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/Service/CpuGeneric/SysSe/Time/Ifx_DateTime.h"
typedef struct
{
    sint32 hours;
    sint32 minutes;
...
# 13 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c" 2
# 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/iLLD/TC27D/Tricore/IfxLldVersion.h" 1
# 14 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c" 2
...
# 16 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c" 2
...
# 18 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Main/Release/AppTaskFu.h"
...
# 110 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
...
# 144 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
...
# 161 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
void ISR_Asc_0_rx(void)
{
    IfxCpu_enableInterrupts();
    IfxStdIf_DPipe_onReceive(&g_AsclinShellInterface.stdIf.asc);
}
# 177 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
void ISR_Asc_0_tx(void)
{
    IfxCpu_enableInterrupts();
    IfxStdIf_DPipe_onTransmit(&g_AsclinShellInterface.stdIf.asc);
}
# 193 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
void ISR_Asc_0_ex(void)
{
    IfxCpu_enableInterrupts();
    IfxStdIf_DPipe_onError(&g_AsclinShellInterface.stdIf.asc);
}
# 206 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
void welcomeScreen(App_AsclinShellInterface *app, IfxStdIf_DPipe *io)
{
    IfxStdIf_DPipe_print(io, "\r\n" """\r\n");
    IfxStdIf_DPipe_print(io, "******************************************************************************""\r\n");
    IfxStdIf_DPipe_print(io, "*******  Welcome to Aurix Racer Shell                               *******""\r\n");
    IfxStdIf_DPipe_print(io, "******************************************************************************""\r\n");
...
boolean AppShell_status(pchar args, void *data, IfxStdIf_DPipe *io)
{
# 265 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
 ...
 AppShell_srvscan(0, ((void *)0), &g_AsclinShellInterface.stdIf.asc );
 AppShell_led0(0, ((void *)0), &g_AsclinShellInterface.stdIf.asc );
 AppShell_led1(0, ((void *)0), &g_AsclinShellInterface.stdIf.asc );
 AppShell_led2(0, ((void *)0), &g_AsclinShellInterface.stdIf.asc );
...
# 320 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
boolean AppShell_motor0en(pchar args, void *data, IfxStdIf_DPipe *io)
{
 sint32 vol;
 if (Ifx_Shell_matchToken(&args, "?") != 0)
...
boolean AppShell_led0(pchar args, void *data, IfxStdIf_DPipe *io)
{
 ...
 if (Ifx_Shell_matchToken(&args, "?") != 0)
    {
        IfxStdIf_DPipe_print(io, "  Syntax     : l0 0/1""\r\n");
    }
    else
    {
     ...
     IfxStdIf_DPipe_print(io, "  Led0: %4d ""\r\n", IR_Port.led0);
    }
...
boolean AppShell_led1(pchar args, void *data, IfxStdIf_DPipe *io)
{
 ...
 if (Ifx_Shell_matchToken(&args, "?") != 0)
    {
        IfxStdIf_DPipe_print(io, "  Syntax     : l1 0/1""\r\n");
    }
    else
    {
     if(Ifx_Shell_parseSInt32(&args, &led) != 0){
     ...
     IfxStdIf_DPipe_print(io, "  Led1: %4d ""\r\n", IR_Port.led1);
    }
...
boolean AppShell_led2(pchar args, void *data, IfxStdIf_DPipe *io)
{
 ...
 if (Ifx_Shell_matchToken(&args, "?") != 0)
    {
        IfxStdIf_DPipe_print(io, "  Syntax     : l2 0/1""\r\n");
    }
    else
    {
     if(Ifx_Shell_parseSInt32(&args, &led) != 0){
     ...
     IfxStdIf_DPipe_print(io, "  Led2: %4d ""\r\n", IR_Port.led2);
    }
...
boolean AppShell_vadcbg1(pchar args, void *data, IfxStdIf_DPipe *io){
 if (Ifx_Shell_matchToken(&args, "?") != 0)
    ...
    else
    {
     ...
     IfxStdIf_DPipe_print(io, "  Ch0: %4.2f,",IR_AdcResult[0]);
     IfxStdIf_DPipe_print(io, "  Ch1: %4.2f,",IR_AdcResult[1]);
     IfxStdIf_DPipe_print(io, "  Ch2: %4.2f,",IR_AdcResult[2]);
     IfxStdIf_DPipe_print(io, "  Ch3: %4.2f,""\r\n",IR_AdcResult[3]);
    }
    return 1;
}
...
# 602 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
boolean AppShell_srvscan(pchar args, void *data, IfxStdIf_DPipe *io)
{
 float32 vol;
 if (Ifx_Shell_matchToken(&args, "?") != 0)
    {
        IfxStdIf_DPipe_print(io, "  Syntax     : srvscan frac-value""\r\n");
    }
    else
    {
     if(Ifx_Shell_parseFloat32(&args, &vol) == 1){
     ...
     IfxStdIf_DPipe_print(io, "  SrvScanAngle: %4.2f fraction""\r\n", IR_SrvScan.Angle);
    }

    return 1;
}
# 627 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/AsclinShellInterface.c"
...
void AsclinShellInterface_init(void)
{
    ...
    g_AsclinShellInterface.info.compilerVer = (4<<16) | (9<<8) | (4);
