...
volatile int BasicGtmTom_run_call_count = 0;
void BasicGtmTom_run(void)
{
 BasicGtmTom_run_call_count = (BasicGtmTom_run_call_count+1) % 10000;
 GtmTomPwmHl_run();
 GtmTomSrv_run();
...
# 528 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/BasicGtmTom.c"
