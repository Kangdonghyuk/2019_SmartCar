...
.LFB419:
	...
	.loc 1 67 0
#APP
	# 67 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/SnsAct/BasicGpt12Enc.c" 1
	enable
	# 0 "" 2
	.loc 1 68 0
#NO_APP
...
.LVL4:
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.19787
	mov	%d4, %d2
	mov	%d5, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d6, 139
	lea	%a6, [%a6] lo:__func__.19787
...
.LVL8:
	...
	mov.aa	%a4, %a15
	.loc 1 154 0
	st.w	[%a12] lo:IR_Encoder, %d2
	.loc 1 155 0
	call	IfxGpt12_IncrEnc_getRawPosition
.LVL9:
	itof	%d2, %d2
	.loc 1 154 0
	lea	%a13, [%a12] lo:IR_Encoder
	.loc 1 156 0
	mov.aa	%a4, %a15
	.loc 1 158 0
	movh.a	%a15, hi:bfencoder
	.loc 1 155 0
	st.w	[%a13] 4, %d2
	.loc 1 156 0
...
.LVL10:
	st.b	[%a13] 8, %d2
	.loc 1 158 0
	ld.w	%d2, [%a15] lo:bfencoder
	ld.w	%d15, [%a12] lo:IR_Encoder
	utof	%d2, %d2
	movh	%d3, 19200
	sub.f	%d2, %d15, %d2
	add	%d3, -2
	...
	.loc 1 158 0
	div.u	%e2, %d2, %d3
	movh.a	%a2, hi:encoder
	st.w	[%a2] lo:encoder, %d3
	.loc 1 159 0
	st.w	[%a15] lo:bfencoder, %d15
	ret
.LFE422:
...
.LVL11:
	.loc 1 172 0
	movh.a	%a15, hi:encoder
	.loc 1 170 0
	mov	%e8, %d5, %d4
	.loc 1 172 0
	ld.w	%d4, [%a15] lo:encoder
.LVL12:
	movh.a	%a15, hi:err
	call	__floatunsidf
.LVL13:
...
.LVL14:
	...
	ld.d	%e6, [%a15]0
	mov	%e4, %d3, %d2
	movh.a	%a15, hi:Kp_tmp
	.loc 1 172 0
	mov	%e8, %d3, %d2
.LVL15:
	.loc 1 175 0
	lea	%a15, [%a15] lo:Kp_tmp
	call	__muldf3
.LVL16:
	st.d	[%a15]0, %e2
	.loc 1 178 0
...
.LVL17:
	ld.d	%e6, [%a15]0
	mov	%e4, %d3, %d2
	movh.a	%a15, hi:Ki_tmp
	call	__muldf3
.LVL18:
	lea	%a15, [%a15] lo:Ki_tmp
	st.d	[%a15]0, %e2
	.loc 1 181 0
	movh.a	%a15, hi:prev_err
	lea	%a15, [%a15] lo:prev_err
	ld.d	%e6, [%a15]0
	mov	%e4, %d9, %d8
	.loc 1 178 0
	mov	%e12, %d3, %d2
...
.LVL22:
	mov	%e4, %d11, %d10
	mov	%e6, %d3, %d2
	movh.a	%a15, hi:PID_PWM
	call	__adddf3
.LVL23:
	lea	%a15, [%a15] lo:PID_PWM
	.loc 1 187 0
	mov	%e4, %d3, %d2
	.loc 1 185 0
	st.d	[%a15]0, %e2
	...
	mov	%d6, 0
	movh	%d7, 16420
	movh.a	%a15, hi:dc_duty
	call	__muldf3
.LVL24:
	lea	%a15, [%a15] lo:dc_duty
	mov	%e4, %d3, %d2
	ld.d	%e6, [%a15]0
	.loc 1 188 0
	movh	%d11, 16543
...
.LVL26:
	...
	movh.a	%a15, hi:dc_pwm
	lea	%a15, [%a15] lo:dc_pwm
	st.d	[%a15]0, %e2
...
.section .rodata.__func__.19787,"a",@progbits
	.type	__func__.19787, @object
	.size	__func__.19787, 19
__func__.19787:
	.string	"BasicGpt12Enc_init"
	.global	dc_pwm
.section .bss.dc_pwm,"aw",@nobits
	.align 2
	.type	dc_pwm, @object
	.size	dc_pwm, 8
dc_pwm:
...
Kp:
	...
	.word	1072064102
	.global	prev_err
.section .bss.prev_err,"aw",@nobits
	.align 2
	.type	prev_err, @object
	.size	prev_err, 8
prev_err:
	.zero	8
	.global	err
...
encoder:
	.zero	4
	.global	bfencoder
.section .bss.bfencoder,"aw",@nobits
	.align 2
	.type	bfencoder, @object
	.size	bfencoder, 4
bfencoder:
	.zero	4
	.global	IR_Encoder
...
.Letext0:
	...
	.file 17 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\tricore\\include\\math.h"
