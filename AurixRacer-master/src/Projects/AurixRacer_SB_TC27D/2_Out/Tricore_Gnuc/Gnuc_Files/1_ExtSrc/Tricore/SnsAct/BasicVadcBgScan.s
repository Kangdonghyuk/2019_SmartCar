...
.LFB393:
	.loc 1 144 0
	.loc 1 145 0
	movh.a	%a15, hi:vadcCount
	ld.w	%d2, [%a15] lo:vadcCount
	mov	%d15, 10000
	add	%d2, 1
	div	%e2, %d2, %d15
	movh.a	%a6, hi:adc_channel_0
	movh.a	%a5, hi:g_VadcBackgroundScan
	movh	%d0, hi:avoidSen
	movh	%d7, hi:IR_AdcResult
	.loc 1 161 0
	movh	%d5, 17792
	ld.w	%d6, [%a6] lo:adc_channel_0
	.loc 1 144 0
	sub.a	%SP, 8
.LCFI1:
	.loc 1 145 0
	st.w	[%a15] lo:vadcCount, %d3
.LVL13:
	.loc 1 150 0
	mov	%d15, 0
	lea	%a5, [%a5] lo:g_VadcBackgroundScan
	addi	%d0, %d0, lo:avoidSen
	addi	%d7, %d7, lo:IR_AdcResult
	.loc 1 161 0
	addi	%d5, %d5, -4096
	mov.a	%a2, 3
.LVL14:
...
.section .text.GetInfraredSensorValue,"ax",@progbits
	.align 1
	.global	GetInfraredSensorValue
	.type	GetInfraredSensorValue, @function
GetInfraredSensorValue:
.LFB394:
	.loc 1 166 0
	.loc 1 167 0
	movh.a	%a15, hi:avoidSen
	lea	%a15, [%a15] lo:avoidSen
	ld.w	%d2, [%a15] 12
	.loc 1 168 0
	ret
.LFE394:
	.size	GetInfraredSensorValue, .-GetInfraredSensorValue
	.global	vadcCount
.section .bss.vadcCount,"aw",@nobits
	.align 2
	.type	vadcCount, @object
	.size	vadcCount, 4
vadcCount:
	.zero	4
	.global	avoidSen
.section .bss.avoidSen,"aw",@nobits
	.align 2
	.type	avoidSen, @object
	.size	avoidSen, 16
avoidSen:
	.zero	16
	.global	adc_channel_0
.section .bss.adc_channel_0,"aw",@nobits
	.align 2
	.type	adc_channel_0, @object
	.size	adc_channel_0, 4
adc_channel_0:
	.zero	4
	.global	IR_AdcResult
